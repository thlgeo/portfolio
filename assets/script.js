...
function popup(event)
{
  ...
  switch (ele.id)
  {
    ...
    case "monstre":
      ...
      break;
    case "odoo":
      document.getElementById("suite-odoo").style.display = "flex";
      break;
    default:
      break;
  }
...
// document.getElementById("titre-site").style.width = 5+document.getElementById("chemin-accueil").offsetWidth+"px";